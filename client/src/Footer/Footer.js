        ...
        <div className="Footer bg-light p-3 mt-4">
            <Container>
                <Row>
                    <Col xs={2}>
                        ONLINE SHOPPING
                        <ol className="list-unstyled lists">
                            <li>Men</li>
                            <li>Women</li>
                            <li>Kids</li>
                            <li>Home & Livings</li>
                            <li>Offers</li>
                            <li>Gift Cards</li>
                            <li>Myntra Insider <Badge variant="danger" className="rounded-pill">New</Badge></li>
                        </ol>
                        </Col>
                    <Col xs={2}>
                        USEFUL LINKS
                        <ol className="list-unstyled lists pl-1">
                            <li>Contact US</li>
                            <li>FAQ</li>
                            <li>T&C</li>
                            <li>Terms of Use</li>
                    ...
                    <Col xs={4}>EXPERIENCE MYNTRA APP ON MOBILE
                         <Row >
                             <Col md={5} className="ml-4"><Image src="https://constant.myntassets.com/web/assets/img/80cc455a-92d2-4b5c-a038-7da0d92af33f1539674178924-google_play.png" width="120px" className="mt-4 ml-5" height="40px" alt="google Play" /></Col>
