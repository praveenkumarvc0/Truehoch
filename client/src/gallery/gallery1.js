...
export default class gallery extends Component{
    ...
    componentDidMount(){
        fetch('http://localhost:7000/getgallery')
        .then(res => res.json())
    ...
    return(
        <div className="mt-5">
        <h1 style={{textAlign:'left',marginLeft:'35px',letterSpacing:'3px',fontSize:'26px'}}>DEALS OF THE DAY</h1>
